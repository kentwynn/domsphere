...
export type paths = {
    ...
    "/sdk/settings": {
        ...
        /** Fetch Settings */
        get: operations["fetch_settings_sdk_settings_get"];
        /** Upsert Settings */
        put: operations["upsert_settings_sdk_settings_put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/embedding/search": {
        ...
        put?: never;
        /** Embedding Search */
        post: operations["embedding_search_embedding_search_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface operations {
    ...
    fetch_settings_sdk_settings_get: {
        parameters: {
            query: {
                siteId: string;
            };
    ...
    upsert_settings_sdk_settings_put: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SiteSettingsPayload"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    embedding_search_embedding_search_post: {
        parameters: {
            query?: never;
            header?: {
                "X-Contract-Version"?: string | null;
